...
// JTabbedPane
		...
		home_panel.add(new JLabel("hello"));
		tp.add("Home", home_panel);

		appointment_panel = new JPanel();
		appointment_panel.add(new JLabel("hello"));
		tp.add("Appointment", appointment_panel);


		main_menu_panel.add(new JLabel("hello"));
		tp.addTab("Menu", main_menu_panel);

		main_search_panel = new JPanel();
		main_search_panel.add(new JLabel("hello"));
		tp.add("Search", main_search_panel);
